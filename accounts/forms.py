...
from .constants import PROFESSION, GENDER_TYPE
...
class UserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name', 'email', 'profession', 'birth_date','gender', 'postal_code', 'city','country', 'street_address']
